...
class APorterStemmer {
    /**
    * Regex for matching a consonant
    * @var string
    */
    private static $consonantRegex = '(?:[bcdfghjklmnpqrstvwxz]|(?<=[aeiou])y|^y)';
    ...
    * @var string
    */
    private static $vowelRegex = '(?:[aeiou]|(?<![aeiou])y)';
